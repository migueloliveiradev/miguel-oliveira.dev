...
namespace migueloliveiradev.Migrations
{
    ...
    [Migration("20230920182121_add_whatsapp_in_about")]
    partial class add_whatsapp_in_about
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("migueloliveiradev.Models.Me.About", b =>
                {
                    ...
                    b.Property<long>("NumberWhatsapp")
                        .HasColumnType("bigint")
                        .HasColumnName("number_whatsapp");

                    b.Property<string>("TextMessageWhatsapp")
                        .IsRequired()
                        .HasColumnType("longtext")
                        .HasColumnName("text_message_whatsapp");
